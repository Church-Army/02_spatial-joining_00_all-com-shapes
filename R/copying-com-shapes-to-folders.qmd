...
```{r fixGwent}
gwent_files <- dir_ls(here(), regex = "gwent", recurse = TRUE, type = "file")

gwent_dir   <- here("gwent-valleys")

file_move(gwent_dir, here("gwent-valley"))

old_gwent_files <- str_replace_all(gwent_files, "gwent-valleys/", "gwent-valley/")
new_gwent_files <- str_replace_all(gwent_files, "gwent-valleys", "gwent-valley")

file_move(old_gwent_files, new_gwent_files)

rm(old_gwent_files, new_gwent_files, gwent_dir, gwent_files)
```
         ...
         expr = 
           {
             ...
             home_dir <- here("..", "01_england-and-wales", "geospatial-data", "com-areas", x)
         ...
         expr = 
           {
             ...
             home_dir <- here("..", "02_scotland", "geospatial-data", "com-areas", x)
         ...
         expr = 
           {
             ...
             home_dir <- here("..", "03_northern-ireland", "geospatial-data", "com-areas", x)
         ...
         expr = 
           {
             ...
             home_dir <- here("..", "04_republic-of-ireland", "geospatial-data", "com-areas", x)
